...
export default async function CareersPage() {
  ...
  return <main>
    <section className="page-hero careers-hero animate-on-scroll">
      <div className="container careers-hero-grid">
        <div className="careers-hero-copy animate-on-scroll delay-1">
        ...
        <div className="careers-hero-panel animate-on-scroll delay-2">
